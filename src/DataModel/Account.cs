...
public class DbAccount
{
	...
	[Required] [MaxLength(128)] public string Category { get; set; } = string.Empty;

	[Required] [MaxLength(255)] public string Name { get; set; } = string.Empty;

	[MaxLength(255)] public string Username { get; set; } = string.Empty;

	[MaxLength(128)] public string Pattern { get; set; } = string.Empty;
	...
	[MaxLength(2)] public string CustomSpecialCharacter { get; set; } = string.Empty;
